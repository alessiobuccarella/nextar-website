      ...
      <section id="home" className="pt-32 pb-20 px-6 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center">
            ...
            {/* Grid Statistiche */}
            <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5 max-w-2xl md:max-w-4xl mx-auto">
              <div className="p-3 md:p-6 bg-zinc-800/30 backdrop-blur-sm rounded-2xl border border-zinc-700/50">
