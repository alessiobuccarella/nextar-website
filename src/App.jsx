      ...
      <section id="home" className="pt-32 pb-20 px-6 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center">
            ...
            {/* Grid Statistiche */}
            <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 max-w-xl md:max-w-4xl mx-auto">
              <div className="px-2 py-3 md:p-6 bg-zinc-800/30 backdrop-blur-sm rounded-2xl border border-zinc-700/50">
                ...
                <div className="text-xs md:text-base text-slate-400 mt-1 md:mt-2 font-medium">Clienti Soddisfatti</div>
              </div>
              <div className="px-2 py-3 md:p-6 bg-zinc-800/30 backdrop-blur-sm rounded-2xl border border-zinc-700/50">
                ...
                <div className="text-xs md:text-base text-slate-400 mt-1 md:mt-2 font-medium">Totale Impressioni</div>
              </div>
              <div className="px-2 py-3 md:p-6 bg-zinc-800/30 backdrop-blur-sm rounded-2xl border border-zinc-700/50">
                ...
                <div className="text-xs md:text-base text-slate-400 mt-1 md:mt-2 font-medium">Supporto Dedicato</div>
              </div>
              <div className="px-2 py-3 md:p-6 bg-zinc-800/30 backdrop-blur-sm rounded-2xl border border-zinc-700/50">
                ...
                <div className="text-xs md:text-base text-slate-400 mt-1 md:mt-2 font-medium">ROI Medio Clienti</div>
              </div>
            </div>
          </div>
        </div>
